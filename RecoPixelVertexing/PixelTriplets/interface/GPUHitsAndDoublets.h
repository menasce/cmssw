...
//====================================================================================
inline void free_gpu_hits(GPULayerHits & hits)
{
  cudaFree(hits.x);
  cudaFree(hits.y);
  cudaFree(hits.z);
...
(
 ...
 const std::vector<HitDoublets> 	       & host_doublets   , 
 const CAGraph  			       & graph  	 ,
...
//====================================================================================
inline void free_gpu_doublets(GPULayerDoublets & doublets)
{
